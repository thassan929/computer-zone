<div class="mx-auto container px-4 py-6 sm:px-6 lg:px-8">
    ...
    if(empty($orders)) {
        ...
        <div class="text-center">
            ...
            <div class="mt-6">
                <a href="<?php echo route('products') ?>" class="inline-flex items-center rounded-md bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-indigo-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 cursor-pointer">
                                ...
                                <?php foreach ($orders as $order): ?>
                                    <tr>
                                        ...
                                        <td class="py-4 pr-4 pl-3 text-right sm:pr-6">
                                            <a href="<?= base_url('user/order/'.$order['id']) ?>" class="text-indigo-600 hover:text-indigo-900">View</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                                </tbody>
