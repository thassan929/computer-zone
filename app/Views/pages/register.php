    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-[480px]">
        <div class="bg-white px-6 py-12 shadow-sm sm:rounded-lg sm:px-12">
            <form action="<?php echo route('register') ?>" method="POST" class="space-y-6">
                ...
                <div>
                    <label for="c-password" class="block text-sm/6 font-medium text-gray-900">Confirm Password</label>
                    <div class="mt-2">
                        <input id="c-password" type="password" name="c-password" placeholder="Confirm password" required autocomplete="current-password" class="block w-full rounded-md bg-white px-3 py-1.5 text-base text-gray-900 outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600 sm:text-sm/6" />
                    </div>
                </div>
        ...
        <p class="mt-10 text-center text-sm/6 text-gray-500">
            Already a member?
            <a href="<?php echo route('login') ?>" class="font-semibold text-indigo-600 hover:text-indigo-500">Login</a>
        </p>
    </div>
</div>
